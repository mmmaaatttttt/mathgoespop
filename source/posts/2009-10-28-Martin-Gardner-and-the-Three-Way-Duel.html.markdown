...
<div style="text-align: center;"><a href="http://upload.wikimedia.org/wikipedia/en/b/ba/DrawingHands.jpg" onblur="try {parent.deselectBloggerImageGracefully();} catch(e) {}"><img style="margin: 0px auto 10px; display: block; text-align: center; cursor: pointer; width: 368px; height: 317px;" src="http://upload.wikimedia.org/wikipedia/en/b/ba/DrawingHands.jpg" border="0" alt="" /></a><span style="font-style: italic;">Drawing Hands</span>

<p><br class="spacer_" /></p>

<p><a href="http://upload.wikimedia.org/wikipedia/en/5/55/Escher_Circle_Limit_III.jpg" onblur="try {parent.deselectBloggerImageGracefully();} catch(e) {}"><img style="margin: 0px auto 10px; display: block; text-align: center; cursor: pointer; width: 425px; height: 425px;" src="http://upload.wikimedia.org/wikipedia/en/5/55/Escher_Circle_Limit_III.jpg" border="0" alt="" /></a><span style="font-style: italic;">Circle Limit III</span></p>

<div style="text-align: justify;">So, what should Mr. White do?  Should he shoot first at Mr. Gray or at Mr. Black?
